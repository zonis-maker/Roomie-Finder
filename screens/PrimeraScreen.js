...
export default function PrimeraScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contenido}>
        ...
        <TouchableOpacity style={styles.botonTemp} onPress={() => navigation.navigate('Home')}>
          <Text style={styles.botonTempTexto}>[ IR A HOME - TEMP ]</Text>
        </TouchableOpacity>
      </View>
